from dialogue_bot.models.action import JoinedAction, NLAction, ContextSetAction, SlotSetAction, ChoiceAction, Choice
...
verify_intent = lambda env, intent_scores, iu_result, dialogue_state, user_input: JoinedAction([
    ...
    SlotSetAction('verify_intent#slots', [
    ...
    ChoiceAction(
        [Choice('intent', i, env.intent(s.ref_id).verify_description, score=s.score) for i, s in enumerate(intent_scores)] +
