LANG_TEXTS = {
    ...
    "invalid_input.1": {
        ...
        "de": [
            "Dein Input ist nicht gültig!" "Dein Input ist ungültig!",
        ],
    },
    "invalid_input.2": {
        "en": ["(Your input might be too long or contains invalid characters)"],
        "de": [
    ...
    "verify_intent_none.1": {"en": ["Sorry that I could not help", "Okay"]},
