...
PROJECT_DIRPATH = os.getenv('DBOT_PROJECT_DIRPATH', os.path.dirname(os.path.abspath(__file__)))
DATA_DIRPATH = os.getenv('DBOT_DATA_DIRPATH', os.path.join(PROJECT_DIRPATH, 'data'))

STATIC_DATA_DIRPATH = os.getenv('DBOT_STATIC_DATA_DIRPATH', os.path.join(DATA_DIRPATH, 'static'))
GENERATED_DATA_DIRPATH = os.getenv('DBOT_GENERATED_DATA_DIRPATH', os.path.join(DATA_DIRPATH, 'generated'))
