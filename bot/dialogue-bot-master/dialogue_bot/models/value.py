...
class Value(KeyComparable):
    ...
    def __init__(self, env: 'BotEnv', id: str,
        ...
        if synonyms is None:
            synonyms = []
            logger.warning('You have not provided synonyms for the entity "{}".'.format(id) +
    ...
    def __repr__(self):
        return '({}: "{}", synonyms={})'.format(self.__class__.__name__, self.id, [s.text for s in self.synonyms])
