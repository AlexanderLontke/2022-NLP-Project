...
def my_nlus(my_bot):
    nlus = {
        ...
        "PhraseExpressionRanker": PhraseExpressionRanker(
            my_bot,
            "PhraseExpressionRanker.phrase",
            VectorTextScorer(
                "PhraseExpressionRanker.phrase.scorer",
                AggTextVectorizer(
                    "PhraseExpressionRanker.phrase.scorer.textvec",
                    NLTKWordTokenizer(
...
@pytest.mark.parametrize("nlu_name", ["RasaNLU", "PhraseExpressionRanker"])
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Currently, i live in the BRD",
            "country-intent-expression",
            1,
            "country",
            "COUNTRY_DE",
        ),
